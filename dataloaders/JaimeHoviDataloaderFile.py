...
def get_paths(train_or_test):
    ...
    if train_or_test == "train":
        path_d = "data_jaime_hovitron/train/sparse/*.png"
        path_gt = "data_jaime_hovitron/train/gt/*.png"
        path_rgb = "data_jaime_hovitron/train/rgb/*.png"
    elif train_or_test == "test":
        path_d = "data_jaime_hovitron/test/sparse/*.png"
        path_gt = "data_jaime_hovitron/test/gt/*.png"
        path_rgb = "data_jaime_hovitron/test/rgb/*.png"
