...
def main():
    ...
    generator = models_gan.GeneratorRRDB(channels=4,filters=16, num_res_blocks=4)#R+G+B+D
    ...
    criterion_pixel = losses.CombinedLoss()
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            for i,batch_data in enumerate(test_dataloader):
                ...
                save_result_row(batch_data, output, "out_"+str(epoch)+".png", folder="outputs/val_pix2pix_revisited_combLoss/")
